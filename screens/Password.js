...
import { StyleSheet, Text, View, TextInput, Dimensions, FlatList, SafeAreaView, TouchableOpacity, BackHandler } from 'react-native';
...
const Password = ({ navigation }) => {
    const [visible, setVisible] = React.useState(true);
    {
        ...
        const addBtn = () => { navigation.push("Add") }
        ...
        return (
            <View style={styles.container}>
                    ...
                    <Modal isVisible={isModalVisible} onBackdropPress={() => setModalVisible(false)} style={{ margin: 0 }}>
                        <View style={{
                            ...
                            <TouchableOpacity style={{ flexDirection: 'row', paddingHorizontal: 30 }}>
                                ...
                                <Text style={{ color: colors.primary, fontSize: 20, fontFamily: 'SemiBold', marginLeft: 20 }}>Copy Password</Text>
                            </TouchableOpacity>
                            ...
                            <TouchableOpacity style={{ flexDirection: 'row', paddingHorizontal: 30, marginVertical: 20 }}>
                                ...
                                <Text style={{ color: colors.primary, fontSize: 20, fontFamily: 'SemiBold', marginLeft: 20 }}>Update Password</Text>
                            </TouchableOpacity>
                        </View>
                    </Modal>
                </View>
                ...
                <Text style={{ color: colors.primary, fontSize: 25, paddingLeft: 18, fontFamily: 'SemiBold' }}>Your Password</Text>
                ...
                <View style={[styles.catgories, styles.elevation]}>
                    ...
                    />
                    <Text style={{ color: '#fff', fontFamily: 'SemiBold', fontSize: 23, marginVertical: 15, paddingHorizontal: 5 }}>Never share your passwords with anyone</Text>
                    <View style={{ flexDirection: 'row', justifyContent: 'center' }}>
                        <Text style={{ color: '#fff', fontFamily: 'SemiBold', fontSize: 23, marginVertical: 10, paddingHorizontal: 5 }}>Briked Passwords</Text>
                        <Text style={{ color: '#fff', fontFamily: 'SemiBold', fontSize: 23, marginLeft: 'auto' }}>10<Ionicons name="md-lock-closed" size={40} color="#fff" /></Text>
                    </View>
                </View>

                <View>
                    <Text style={{ fontFamily: 'SemiBold', fontSize: 23, color: colors.primary, marginTop: 10, paddingHorizontal: 10 }}>Briked Passwords</Text>
                </View>
